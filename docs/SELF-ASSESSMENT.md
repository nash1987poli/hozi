...
| 14 | Demo script and screenshots present; live URL | **Yes** | `docs/DEMO-SCRIPT.md` — shot-by-shot film script + live walkthrough; `docs/TESTING-EVIDENCE.md` — engine output screenshots; `docs/screenshot.jpg`; **live URL: https://hozi-xi.vercel.app/** |
...
| 4 | Public repository link | **Ready** | https://github.com/nash1987poli/hozi (public); live demo deployed from repo, served on Vercel |
...
| 4 | Repository | Done | git repo at https://github.com/nash1987poli/hozi; live demo deployed from repo, served on Vercel |
| 5 | Architecture diagram | Done | `docs/ARCHITECTURE.md` |
| 6 | Data and AI note | Done | `docs/DATASET-STATEMENT.md` + `docs/AI-USAGE-NOTE.md` |
| 7 | Demo link | Done | https://hozi-xi.vercel.app/ (live); `docs/DEMO-SCRIPT.md` ready |
